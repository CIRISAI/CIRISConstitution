...
|---|---|---|
| `capacity:*` ([CC 3.1.8.1](part_3_the_namespace.md)) | **Anti-self** — `attesting_key_id` MUST NOT equal `attested_key_id`. | The agent's own capacity score is never fed back into the agent's own context — anti-Goodhart per CIRISAgent CC 3.1.2. |
