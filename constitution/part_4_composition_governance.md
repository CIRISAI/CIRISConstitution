...
| `license` | a `licensure:{authority_id}` / `attestation:license_validity` attestation, **on behalf of a delegator that itself holds licence authority** by quorum ([CC 3.3.9](part_3_the_namespace.md)) — the scope conveys the right to *issue*, never the authority itself ([CC 2.4.1.2.1](part_2_the_grammar.md): a licence does not chain) | [CC 3.1.2](part_3_the_namespace.md) / [CC 3.1.1](part_3_the_namespace.md) |
